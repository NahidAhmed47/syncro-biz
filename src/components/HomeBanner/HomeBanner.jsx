            ...
            <div className='w-full h-full pt-28 max-container grid lg:grid-cols-2 gap-4'>
                <div className=' px-3 pb-14 flex flex-col justify-center space-y-3  md:space-y-7'>
                    ...
                    <div className='flex gap-5 items-center'>
                        <Link href="/about"><ButtonPrimary bgColor="bg-white text-primary">About Us</ButtonPrimary></Link>
                ...
                <div className=' h-full w-full hidden lg:inline-block'>
                    <div className='relative h-full w-full z-10 animate-up-down' >
                        ...
                        <Image src={sideImg4} fill={false} alt='sideimg4' className='absolute bottom-16 right-28'></Image>
                    </div>
                </div>
            </div>
