...
const ButtonPrimary = ({children, bgColor}) => {
  return (
    <button name="submit" className={`md:min-w-[140px] h-fit relative ${bgColor ? bgColor : 'bg-primary text-white'} text-sm   sm:text-lg px-4 md:px-6 py-2 font-medium rounded-lg flex items-center justify-center overflow-hidden group`}>
