...
const DataAccordianCard = ({active, index , card}) => {
    return (
        <div className={`flex mt-12 md:mt-16 gap-4 ${active != index && 'hidden'}`}>
                ...
                <p className='text-gray-400  max-w-[700px]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Risus commodo viverra maecenas accumsan lacus vel facilisis.</p>
                    <div className='flex items-center gap-2'>
                        <BsCheck2All className='text-primary w-6 h-6'></BsCheck2All>
                        <p className='text-gray-500 font-semibold text-base'>Professional Consultancy Service</p>
                    </div>
                    <div className='flex items-center gap-2'>
                        <BsCheck2All className='text-primary w-6 h-6'></BsCheck2All>
                        <p className='text-gray-500 font-semibold text-base'>Professional Consultancy Service</p>
